...
![LLM驱动的智能体核心组件架构.png](./images/10.png)
...
1. 字节对编码BPE：核心思想可理解为一个 贪心 的合并过程
  ...
  2. 迭代合并：语料库上，统计所有相邻词元对的出现频率，找到频率最高的一对，将他们合并成一个新词元，并加入词表
  3. 重复：重复第二步，直到词表大小达到预设的阈值

2. WordPiece算法：与BPE相似，合并词元标准是 能最大化提升语料库的语言模型概率
...
+ 模型幻觉Hallucination
  ...
  + 幻觉本质：模型生成过程中，过度自信地 __编造__ 了信息，而非准确地检索或推理
