...
## 十一、焦点切换（终端 ↔ 编辑器 ↔ 侧边栏 ↔ Chat）

| 按键                   | 作用                                        |
| ---------------------- | ------------------------------------------- |
| `` Ctrl + ` ``         | 聚焦 / 切换**终端**（已配）                 |
| `Ctrl + Shift + `` `   | **新建终端**（已配）                        |
| `Ctrl + 1` / `2` / `3` | 聚焦第 1 / 2 / 3 个**编辑组**（已配）       |
| `Ctrl + 0`             | 聚焦**侧边栏**（资源管理器）                |
| `Ctrl + Shift + E`     | 聚焦**资源管理器**（已配）                  |
| `Ctrl + Shift + F`     | 聚焦**搜索**面板                            |
| `Ctrl + Shift + I`     | 打开 / 聚焦 **Copilot Chat**                |
| `Ctrl + J`             | 显示 / 隐藏**底部面板**（终端、输出、问题） |

> **快速切换流程**：终端 → `Ctrl + 1` → 编辑器 → `Ctrl + 0` → 侧边栏 → `Ctrl + Shift + I` → Copilot Chat → `Ctrl + 1` → 编辑器 → `` Ctrl + ` `` → 终端
